...
for (let i = 0; i < 5; i++) { // Cadastra os 5 itens do catálogo; itens de índice par recebem uma mensagem extra de promoção
    console.log(`O item ${catalogo_itens[i]} foi cadastrado com sucesso!`)
    if (i % 2 === 0) {
